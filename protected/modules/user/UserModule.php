...
class UserModule extends WebModule
{
	...
	public $monthPrice = 30;
	public $yearPrice = 300;
    ...
    public function getParamsLabels()
    {
        return [
			...
			'monthPrice'               => Yii::t('UserModule.user', 'Price for month'),
			'yearPrice'                => Yii::t('UserModule.user', 'Price for year'),
    ...
    public function getEditableParamsGroups()
    {
        return [
			'special'      => [
				'label' => Yii::t('UserModule.user', 'Special module settings'),
				'items' => [
					'monthPrice',
					'yearPrice'
				],
