...
class ProfileForm extends CFormModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['dj_name, first_name, last_name, middle_name, about', 'filter', 'filter' => 'trim'],
            [
                'first_name, last_name, middle_name, about',
                'filter',
                'filter' => [$obj = new CHtmlPurifier(), 'purify']
            ],
			['dj_name, first_name, last_name, phone, country, zip', 'required'],
            ['gender', 'numerical', 'min' => 0, 'max' => 3, 'integerOnly' => true],
            ['gender', 'default', 'value' => 0],
            ['birth_date', 'default', 'value' => null],
            ['birth_date', 'date', 'format' => 'yyyy-mm-dd'],
            ['first_name, last_name, middle_name', 'length', 'max' => 50],
